...
class ticket_admin(admin.ModelAdmin):
    list_display = ['project', 'ticket_id', 'ticket_title','customer','ticket_type','date_opened','priority', 'get_assigned_users','last_updated', 'last_updated_by', 'state', 'operational_notes','closed_date','solution']
